...
namespace net {
    ...
    /**
     * @brief The multipurpose base_socket class provides LINUX OS specific *both* client and server behaviour for (all) protocols.
    ...
    public:
         ...
         */
        explicit base_socket(sockfd_t socket);

        /**
         * @brief base_socket::base_socket - constructs an easily restartable socket from an address family, socket type and protocol.
         * @param address_family - IPv4, IPv6, IrDA, Bluetooth
         * @param socket_type - STREAM, DGRAM, RAW, RDM
         * @param protocol - ANY, TCP, UDP, ICMP, IGMP, RFCOMM, ICMPv6, PGM
         */
        base_socket(sa_family_t address_family, int socket_type, int protocol);
        ...
        /**
         * @brief server_accept_and_create_socket - used with connection-based socket types
         ...
         * @return socket template type - the newly created socket
         */
        unsigned int accept_and_create_sockfd() override final;
    ...
    private:
        ...
        int _socket_type;
        int _protocol;
        sockfd_t _socket; //socket file descriptor
